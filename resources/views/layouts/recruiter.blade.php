...
<body class="bg-gray-50 font-sans">
    ...
    <header class="bg-white border-b px-4 lg:px-6 py-4 flex justify-between items-center sticky top-0 z-30 ">
        ...
        <div class="flex items-center space-x-2 lg:space-x-4 md:mr-10">
            ...
            <button id="open-modal"
             ...
             <livewire:@livewire('recruiter.request-teacher')
           ...
           <div>
                ...
                <div id="avatarButton" type="button" data-dropdown-toggle="userDropdown"
                    ...
                    <img data-dropdown-placement="bottom-start"
    ...
    <main class="flex flex-col lg:flex-row  lg:pt-0">
        ...
        <aside class="sidebar-container w-full lg:w-64 flex-shrink-0">
            <div id="sidebar"
                class="mobile-menu fixed top-0 left-0 h-[100vh] w-64 bg-white p-4 border-r overflow-y-auto custom-scroll lg:relative lg:translate-x-0 lg:top-auto lg:left-auto lg:h-[87vh] lg:shadow-none">
